    ...
    <div className="container">
      ...
      <section className="section mb-4">
        <div className="flex justify-between mb-2">
          <div>
            <h2 className="text-xl font-bold">NoteFlip (site might be down -- apologies)</h2>
            <div className="text-sm">
              <Link href="https://noteflip.io" className="mx-1">{`[web]`}</Link>
        ...
        <ul className="list-disc pl-6 text-xs">
          <li>Developed a cross-platform educational app that converts handwritten notes into interactive flash cards</li>
          <li>Designed a scalable backend using FastAPI and PostgreSQL, integrating Google Cloud Vision for OCR and OpenAI&apos;s API for content processing</li>
          <li>Built dual-platform frontend interfaces with React Native for mobile and Next.js for web, ensuring seamless user experience</li>
        </ul>
      </section>
      ...
      <section className="section mb-4">
        <div className="flex justify-between mb-2">
          <div>
            <h2 className="text-xl font-bold">mnk-Game</h2>
            <div className="text-sm">
        ...
        <ul className="list-disc pl-6 text-xs">
          <li>Created a generalized m,n,k-game (like Tic-Tac-Toe) with emoji pieces and customizable board sizes/win conditions</li>
      ...
      <section className="section mb-4">
        <div className="flex justify-between mb-2">
          <div>
            <h2 className="text-xl font-bold">TextWolfram</h2>
            <div className="text-sm">
        ...
        <ul className="list-disc pl-6 text-xs">
          <li>Developed a text messaging conversation service that gives fast responses to technical questions</li>
          <li>Used WolframAlpha Conversational API for generating accurate human-like responses within two seconds of a message, Twilio webhooks with ngrok for deploying to a live server</li>
      ...
      <section className="section mb-4">
        <div className="flex justify-between mb-2">
          <div>
            <h2 className="text-xl font-bold">Woodlands CS Website</h2>
            <div className="text-sm">
        ...
        <ul className="list-disc pl-6 text-xs">
          <li>Created an educational blog-style website using Jekyll and Ruby, featuring Pyodide-powered interactive code execution, syntax highlighting, and LaTeX rendering</li>
        </ul>
      </section>
        ...
        <div className="flex justify-between mb-2">
          <div>
            <h2 className="text-xl font-bold">Bee-ware!</h2>
            <div className="text-sm">
      ...
      <section className="section mb-4">
        <div className="mb-2">
          <h2 className="text-xl font-bold">My old games</h2>
          <div className="text-sm">
      ...
      <section className="section mb-4">
        <div className="mb-2">
          ...
          <div className="text-sm">
            <Link href="https://anaether.bandcamp.com/" target="_blank" className="mx-1">{`[bandcamp]`}</Link>
          </div>
        </div>
      </section>
      ...
      <section className="section mb-4">
        ...
        <ul className="list-disc pl-6 text-xs">
          <li><Link href="https://i.imgur.com/rTCYwFT.jpeg" target="_blank" className="text-blue-500">Fall </Link>
          <Link href="https://i.imgur.com/vebN3u2.jpeg" target="_blank" className="text-blue-500">is </Link>
          <Link href="https://i.imgur.com/6kNIVcH.jpeg" target="_blank" className="text-blue-500">my </Link>
          <Link href="https://i.imgur.com/OFmlbA6.jpeg" target="_blank" className="text-blue-500">only </Link>
          <Link href="https://i.imgur.com/iQXy31w.jpeg" target="_blank" className="text-blue-500">good </Link>
          <Link href="https://i.imgur.com/pqJifak.jpeg" target="_blank" className="text-blue-500">season.</Link>
          </li>
        </ul>
      </section>
    </div>
